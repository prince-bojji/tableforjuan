  ...
  return (
    ...
    <div className='h-full font-montserrat px-0 py-40 bg-[#fff7f4]'>
      ...
      <div className='min-h-[calc(100%_-_60px)] mx-auto'>
        <div className='sm:min-w-[70vw] min-h-[70vh] w-9/12 overflow-auto bg-[#9ACEB4] shadow-[0rem_0rem_0_10px_#FFE8E8] mx-auto my-0 p-4 rounded-[3rem_0]'>
          <div className='text-[#4E4141] text-[1.2em] not-italic text-center mt-12 mb-0 mx-16'>
            ...
            <div className='max-w-full h-[430px] w-full overflow-hidden mt-0 mb-12 mx-0'>
