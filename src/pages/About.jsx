...
function About() {
  ...
  <div className="ourstory sm:w-full">
    <div className="relative w-full overflow-hidden isolate bg-[url('src/images/About/news.jpg')] bg-cover bg-no-repeat">
        <div className="absolute inset-0 bg-[rgba(233, 230, 230, 0.8)] backdrop-filter backdrop-blur"></div>
      <div className="after:content-[''] after:absolute after:z-[-1] after:opacity-80 after:inset-0" style={{ background: "rgb(233, 230, 230)" }} />
        <div className="grid grid-cols-2 items-center gap-x-10 mx-auto my-0 p-10 md:p-40 sm:grid-cols-1 sm:gap-y-5 sm:p-10">
          <div className="carousel-container sm:row-2">
            <div className="carousel h-full w-full relative overflow-hidden shadow-[0px_0px_20px_rgba(0,0,0,0.9] rounded-3xl">
              {/*Slider*/}
              <div className="slider flex max-h-full w-[100%] shrink-0 transition-all duration-[0.5s] ease-[ease]">
              ...
              {/*Description*/}
              <div className="desc h-full bg-[rgba(236,214,211,0.7)] shadow-[0px_0px_20px_rgba(0,0,0,0.4)] p-12 rounded-[10px]">
                <h1 className="text-left text-[#ea6a91] -mt-px text-7xl font-montserrat">
                  OUR STORY
                </h1>
                <p className="text-justify text-[25px] text-[#363636] font-montserrat">
  ...
  {/*SECOND PANEL */}
  <section className="container bg-[#e5ece9] max-w-full flex items-center justify-center">
  <div className="testimonial mySwiper relative max-w-[1800px] w-full overflow-hidden px-0 py-[50px]">
    <div className="testi-content swiper-wrapper">
      ...
      <div className="slide swiper-slide flex items-center justify-center flex-col gap-y-[30px] h-full w-full">
        <h1 className="text-center mt-[-5px] text-[80px] text-[#E79898] font-montserrat">MISSION</h1>
      ...
      <div className="slide swiper-slide flex items-center justify-center flex-col gap-y-[30px] h-full w-full">
        <h1 className="text-center mt-[-5px] text-[80px] text-[#E79898] font-montserrat">VISION</h1>
        <p className="text-center text-[35px] text-[#363636] px-40 py-0 font-montserrat">
  ...
  <div className="th_cont absolute -translate-x-2/4 -translate-y-2/4 flex justify-center items-center left-2/4 top-2/4">
    ...
    <div className="image-column relative w-[65vh] h-[90vh] mt-5 mx-auto my-0 pb-[40%] rounded-[20%]">
      ...
      <div className="slide_img" id="one">
        <img src="src/images/About/behind.jpg" alt="Image 1" className="w-full h-full shadow-[5px_5px_15px_rgba(0,0,0,0.2)] rounded-[10px]" />
      ...
      <div className="slide_img" id="two">
        <img src="src/images/About/behind1.jpg" alt="Image 2" className="w-full h-full shadow-[5px_5px_15px_rgba(0,0,0,0.2)] rounded-[10px]" />
      ...
      <div className="slide_img" id="three">
        <img src="src/images/About/behind2.jpg" alt="Image 3" className="w-full h-full shadow-[5px_5px_15px_rgba(0,0,0,0.2)] rounded-[10px]" />
      ...
      <div className="slide_img" id="four">
        <img src="src/images/About/behind3.jpg" alt="Image 4" className="w-full h-full shadow-[5px_5px_15px_rgba(0,0,0,0.2)] rounded-[10px]" />
