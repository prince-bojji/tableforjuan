...
const SecondPanel = (props) => {
  return (
    <div className="flex items-center justify-center flex-col gap-y-[20px] h-full w-full">
      <h1 className="text-center text-5xl md:text-7xl text-[#E79898] font-semibold font-montserrat">{props.name}</h1>
      <p className="border-t-2 border-[#363636] max-w-[70vw] text-center text-base md:text-xl text-[#363636] pt-6 font-montserrat">
        {props.children}
      </p>
    </div>
  );
  ...
  return (
    <div className=' '>  
      ...
      <section className="w-full">
        <div className="h-screen w-full relative">
          ...
          <div className="absolute inset-0 h-full pt-[80px] flex justify-center items-center bg-white bg-opacity-20 backdrop-blur-[2px]">
            <div className="h-full lg:h-fit flex flex-col justify-center items-center gap-9 p-6 sm:p-12 bg-[#fff7f4] bg-opacity-70 mx-auto max-w-[600px]">
              <h1 className="text-center text-[#9E6B67] text-5xl sm:text-7xl font-courgette">
                Our Story
              </h1>
              <p className="text-justify text-base sm:text-xl text-[#363636] font-montserrat">
      ...
      <section className='flex justify-center min-h-screen relative w-full bg-cover bg-center bg-[url("/src/images/About/th_bg.jpg")] overflow-hidden'>
        ...
        <div className='grid grid-cols-1 lg:grid-cols-2 gap-14 items-center w-[90vw] lg:w-[70vw] min-h-[70vh] py-10 px-5 m-auto overflow-hidden z-0'>
          <div className='flex flex-col font-montserrat justify-center gap-3 xl:gap-8'>
            <h2 className="text-left text-[#E79898] text-5xl sm:text-7xl font-bold">Behind the Table</h2>
            <p className='text-[#AC6868] text-justify text-base sm:text-xl'>
